      ...
      <div>
          {books.map((book) => (
            ...
            <div key={book.id} className=' grid m-6 mx-12 sm:mx-12 md:mx-40 lg:mx-80 bg-slate-300 hover:bg-purple-300 border-violet-900 shadow-inner border rounded-lg '>
                ...
                <button className='bg-black hover:bg-white text-white hover:text-black hover:font-bold p-1 mx-28 sm:mx-28 md:mx-40 lg:mx-56 mt-3 mb-3 rounded-md'>See More</button>
            </div>
            ))
        }
      </div>
